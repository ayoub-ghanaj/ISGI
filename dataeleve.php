...
$result=$conn->query("SELECT * FROM users WHERE rank='etudiant'");
...
<tr id="<?php echo $data['username'].'etudiant' ?>">
    ...
    <td><button type="button" name="button" class="button-3" onclick="Updateeleve('<?php echo $data['username'];?>','<?php echo $data['passw'];?>','<?php echo $data['email'];?>','<?php echo $data['rank'];?>','<?php echo $data['loger'];?>','<?php echo $data['sessions'];?>','<?php echo $data['dated'];?>');">Modifier</button></td>
</tr>
